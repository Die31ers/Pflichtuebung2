 ...
 *
 *
 * Status von Teams werden auf der Konsole angezeigt!
 */
public class GameViewer {
	private static int i = 0;

	/** Hier wird der aktuelle Spielstand sowie Runde über die statische 
	 * Methode <code>printGame(GameController game) ausgegeben.
	 * @param game
	 */
